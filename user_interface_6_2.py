import sys
import time
from PyQt5.QtWidgets import (QApplication, QWidget, QPushButton, QVBoxLayout, QLabel,QHBoxLayout, QGridLayout, QGroupBox, QLineEdit, QTabWidget)
...
class MainWindow(QWidget):
    ...
    LOCATIONS = {
        # 96 SAMPLE HOLDER
        1: (130.0+ xg0, 182.0+ yg0),
        2: (95.0+ xg0, 182.0+ yg0),
        3: (58.0+ xg0, 182.0+ yg0),
        4: (130.0+ xg0, 147.0+ yg0),
        5: (95.0+ xg0, 147.0+ yg0),
        6: (58.0+ xg0, 147.0+ yg0),
       ...
       11: (0.0, 0.0),
       # 24 SAMPLE HOLDER
       12: (78.0 + xg1, 192.0 + yg1),
       13: (39.0 + xg1, 192.0 + yg1),
       14: (0.0 + xg1, 192.0 + yg1),
       15: (78.0 + xg1, 153.0 + yg1),
       16: (39.0 + xg1, 153.0 + yg1),
       17: (0.0 + xg1, 153.0 + yg1),
       # 12 SAMPLE HOLDER
       18: (138.0 + xg2, 167.0 + yg2), #25, 199  -> -113, +32
