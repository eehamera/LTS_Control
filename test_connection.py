...
# Note that you might need to specifically use python 3.10 to run this

# These imports use files from the Kinesis software
clr.AddReference("C:\\Program Files\\Thorlabs\\Kinesis\\Thorlabs.MotionControl.DeviceManagerCLI.dll")
clr.AddReference("C:\\Program Files\\Thorlabs\\Kinesis\\Thorlabs.MotionControl.GenericMotorCLI.dll")
clr.AddReference("C:\\Program Files\\Thorlabs\\Kinesis\\Thorlabs.MotionControl.IntegratedStepperMotorsCLI.dll")

# Note that on my computer, these imports are flagged as not resolved but the program still works fine
from Thorlabs.MotionControl.DeviceManagerCLI import *
from Thorlabs.MotionControl.GenericMotorCLI import *
from Thorlabs.MotionControl.IntegratedStepperMotorsCLI import *
from System import Decimal  # necessary for real world units

# UNITS: time: ms,  distance: mm,  velocity: mm/s
...
def main():
    ...
    try:
        ...
        # create new device
        serial_no = "45863008"  # Replace this line with your device's serial number
        ...
        new_pos = Decimal(100.0)  # Must be a .NET decimal
